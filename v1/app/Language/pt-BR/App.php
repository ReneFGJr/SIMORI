...
return [
    'regs_0_1' => '<span class="text-danger">Registros deletados</span>',
    'regs_1_0'  => '<span class="text-success">Registros coletados</span>',
    'records'   => '<span class="text-info">Total de registros</span>',
    'sets'    => '<span class="text-warning">Total de comunidades</span>',
